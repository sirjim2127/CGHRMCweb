    ...
    <div className="flex-1 w-full">
      <div className="p-4">
        ...
        <Content>
          ...
          organization. Likewise, COHRMC assumed administrative and operational
          control of four (4) Special Service Commands. namely, Coast Guard
          Special Services Office (cesso), Coast Guard Gender and Development
          (CGGAD), pension and Gratuity Management Center (POMC), and
          Non-uniformed Personnel Altairs Office (NUPAO).
        </Content>
        <Content>
          ...
          Promotional Examination (PROMEX) was transferred to CHRMC, PROMEX was
          designed to evaluate arid recognize the knowledge, skills, and
          capabilities of Coast Guardians, enabling them to progress in their
          Coast Guard based on merit and performance. in 2023, COHRMC officially
          embarked on its Performance Governance System (POs) Transformative
          Journey through the assistance of the institute for Solidarity in Asia
          (ISA), the exclusive organization providing PGS services. On 10 August
          2023, the Command us conferred POS Initiated Status with Silver
          Trailblazer Award after successfully designing its strategy aimed at
          becoming An internationally certified HR Management Command in support
          to the mission of PC by 2028. In the same year, PGS literally
          transformed COHRMC as it triggered its re-structuring from a linear to
          ...
          prompting the rebranding of the Procurement and Attrition Division as
          the Human Resource Procurement Center (HRPC), thereby becoming the
          fourth Core Function Unit of CGHRMC alongside CMC, PMC, and RBAS. To
          facilitate this transformation, the Command bolstered its internal
          capacities by renaming its gervice support units. STI was renamed as
          the Human Resource Management School (HRMS), cessO was enlarged into
          the Coast Guard Special Services Center (coSSc), and COGAD underwent
          reform to become the Gender and Development Center (GADC).
          Furthermore, to prioritize automation, the information and Technology
          Center (iTC) was also established as the fifth Service Support Unit
          alongside HRMS, CGSSC, CGGAD, and NUPAO. Throughout its brief history,
          the COHRMC has evolved into a comprehensive and vital institution,
          focusing on the management and development of human resources within
          the PC organization. By streamlining recruitment processes, providing
          specialized training and overseeing the administrative and operational
          aspects of various units, the CGHRMC plays a crucial role in ensuring
          the success and growth in the dynamic public service landscape,
          however, it still seeks to bring the Coast Guard organization to a
          higher level of success in delivering service to the whole of the PC
          that shall radiate to the general public.
        </Content>
      </div>
    </div>
  );
